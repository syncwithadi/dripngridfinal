...
export default function Categories({ categories }: CategoriesProps) {
  ...
  return (
    <>
        ...
        {panels.map((category) => {
          ...
          return (
            <Link
              ...
              className="group relative overflow-hidden cursor-pointer flex-shrink-0 snap-start"
              style={{
                width: '72vw',
                aspectRatio: '3/4',
                marginRight: '8px',
            ...
            >
              ...
              <div className="absolute bottom-7 left-5 z-10">
                <h2 className="text-white text-2xl font-black tracking-wider uppercase mb-3 drop-shadow-lg">
                  {category.name}
                </h2>
                <div
      ...
      {/* ── DESKTOP: classic side-by-side panels ──────────────────────── */}
      <section id="categories" className="hidden md:flex w-full">
